...
import 'package:poem/src/core/localization/generated/l10n.dart' as generated show GeneratedLocalization, AppLocalizationDelegate;
...
final class Localization extends generated.GeneratedLocalization {
  ...
  static Locale computeDefaultLocale() {
    ...
    if (const generated.AppLocalizationDelegate().isSupported(locale)) return locale;
...
final class _LocalizationView extends LocalizationsDelegate<Localization> {
  ...
  Future<Localization> load(Locale locale) =>
      generated.GeneratedLocalization.load(locale).then<Localization>((localization) => Localization._current = Localization._(locale));
